...
enum class AppScene { SSH, MP3, NOTES, SETTINGS, GAMES, FILES, IR_REMOTE, PHOTOS, VOICE_MEMOS, HID_KEYBOARD, USB_STORAGE, TIMER, GPS, LORA, NFC, PAYLOADS, BLE, DETECTOR, WIFI_TOOLS, CC1101, NRF24, ESPNOW, SD_HEALTH };
